     ...
     <div id="aCoursesList">
                  ...
                  <div class="cc-l-wrap">
                    ...
                    <section class="mt10 hLh20 of">
                      ...
                      <span class="fl jgAttr c-ccc f-fA">
                        <i class="c-999 f-fA">浏览人数：{{course.view_count}}</i>
                        |
      ...
      <div>
        <section class="container">
          <header class="comm-title">
            <h2 class="tac">
              <span class="c-333">著名教授&杰出校友</span>
            </h2>
          </header>
          <div>
                  ...
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a :href="'/teacher/'+teacher.id" title="teacher.name">
                        <img :alt="teacher.avatar" :src="teacher.avatar">
                      </a>
                    </div>
            ...
            <section class="tac pt20">
              <a href="/teacher" title="全部讲师" class="comm-btn c-btn-2">全部魔法师</a>
            </section>
          </div>
        </section>
      </div>
